...
public class BrowserMatchExtension implements ExecutionCondition {
    ...
    public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext extensionContext) {
        ...
        if (matches) {
            ...
            return ConditionEvaluationResult.disabled("Тест пропущен, так как текущий браузер " + currentBrowser + " не находится в списке допустиых браузеров для теста: " + Arrays.toString(annotation.value()));
        }
    }
}
